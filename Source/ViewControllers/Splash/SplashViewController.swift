...
public class SplashViewController: UIViewController {
    ...
    init(with viewModel: SplashViewModel = SplashViewModel()) {
    ...
    func setupViews() {
        ...
        containerView.addSubviews(with: [titleLabel, collectionView, containerIdentityView, versionLabel, containerStackView])
