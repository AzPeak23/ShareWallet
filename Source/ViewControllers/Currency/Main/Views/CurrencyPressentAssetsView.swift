...
//    }()
    ...
    private let refreshButton: UIButton = {
        let button = UIButton()
        button.setImage(UIImage(named: "refresh_home_screen_icon"), for: .normal)
        button.backgroundColor = .clear
...
//        }
    ...
    func setData(with fullAmount: String, and shouldHideData: Bool) {
        ...
        assetsImageView.image = UIImage(named: "pressent_assets_all_crypto")
        ...
        eyeButton.setImage(UIImage(named: shouldHideData ? "showing_data_home_screen_icon" : "hidden_data_home_screen_icon"), for: .normal)
    }
