...
//
 */
FOUNDATION_EXPORT NSString* _Nonnull Cold_walletGenerateUserAccount(NSString* _Nullable lang, NSString* _Nullable secret);
 ...
 */
FOUNDATION_EXPORT BOOL Cold_walletRecoverUserAccount(NSString* _Nullable secret, NSString* _Nullable seedPhrase);
