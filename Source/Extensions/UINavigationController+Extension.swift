...
extension UINavigationController {
    ...
    func removeViewControllerPreviousHome() {
        let controllers = [BackupNoticeViewController.self, SetPinCodeViewController.self, BackupSecondNoticeViewController.self, BackUpMnemonicPhraseViewController.self, ConfirmPhrasesViewController.self, RecoveryPhrasesViewController.self]
