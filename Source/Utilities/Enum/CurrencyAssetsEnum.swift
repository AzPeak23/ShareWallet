...
public enum CurrencyAssetsEnum {
    ...
    static func getAssetsEnumType(by coinType: Int) -> CurrencyAssetsEnum {
        switch coinType {
        case 1: return .btc
        case 2: return .eth
        case 3: return .usdtErc20
        case 4: return .trx
        case 5: return .usdtErc20
        default: return .btc
        }
    }
    ...
    var homeIconBackgroundColor: UIColor {
        switch self {
    ...
    var cardIconBackgroundColor: UIColor {
        switch self {
        case .btc: return .wWDarkGold
    ...
    var nameOnlyForTransfer: String {
        switch self {
        case .btc: return "BTC"
